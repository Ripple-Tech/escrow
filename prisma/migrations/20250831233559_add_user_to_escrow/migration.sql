...
-- CreateEnum
CREATE TYPE "EscrowStatus" AS ENUM ('PENDING', 'RELEASED', 'CANCELLED');
...
-- CreateIndex
CREATE INDEX "Escrow_senderId_idx" ON "Escrow"("senderId");

-- CreateIndex
CREATE INDEX "Escrow_receiverId_idx" ON "Escrow"("receiverId");
...
-- AddForeignKey
ALTER TABLE "Escrow" ADD CONSTRAINT "Escrow_senderId_fkey" FOREIGN KEY ("senderId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Escrow" ADD CONSTRAINT "Escrow_receiverId_fkey" FOREIGN KEY ("receiverId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
